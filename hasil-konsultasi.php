        ...
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="jumbotron jumbotron-fluid">
                        ...
                        <div class="container">
                            <div style="padding-left: 3%;">
                                <?php
                                if ($nmpkt[1] != "Tidak memiliki kecenderungan mengalami gejala ke arah Skizofrenia")  {
                                    ...
                                    echo "<p style='font-size: 20px;font-weight:20' class='lead fw-normal'>Anda memiliki kecenderungan mengalami gejala ke arah $nmpkt[1] sebesar " . number_format($vlpkt[1] * 100) . "%</p>";
                ...
                <div class="card" style="margin-top: 2%;">
                    ...
                    <div class="card-body">
                        <?php echo htmlspecialchars_decode($keterangan_penyakit[$idpkt[1]]); ?>
                    </div>
                </div>
                <div class="card" style="margin-top: 2%;">
            ...
            <!--<a href="print-hasil.php" class="btn btn-primary">Cetak Hasil Diagnosa</a>-->
             <form action="print-hasil.php" method="POST" target="_blank">
                    <?php for ($no = 0; $no < count($_POST['kondisi']); $no++) { ?>
                    <input type="hidden" name="kondisi[]" value="<?= $_POST['kondisi'][$no]; ?>">
                    <?php } ?>
                <button type="submit" class="btn btn-primary btn-konsultasi" name="print">Print</button>
            </form>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">

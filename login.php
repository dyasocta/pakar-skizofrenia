...
<body id="home">
    <nav class="nav-custom navbar navbar-expand-lg navbar-light bg-light fixed-top mb-4">
        <div class="container pt-2">
            ...
            <button class="navabr-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="container mt-5">
            <div class="row-cols-auto">
                <div class="col-12 col-lg-4">
                    <h2>Login Admin</h2>
                    <h3>Pastikan isi dengan benar ya !</h3>
                </div>
                <div class="row mt-5">
                    <div class="col-md-6">
